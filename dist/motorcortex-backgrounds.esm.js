...
var BgOpener = /*#__PURE__*/function (_HTMLClip) {
  ...
  _createClass(BgOpener, [{
    ...
    value: function buildTree() {
      ...
      var bgPositionOne = new CSSEffect({
        animatedAttrs: {
          top: "-".concat(this.attrs.height / 2, "px")
        },
        initialValues: {
      ...
      var wrapperHeight = new CSSEffect({
        animatedAttrs: {
      ...
      var wrapperHeightOut = new CSSEffect({
        animatedAttrs: {
      ...
      var wrapperHeightOutOne = new CSSEffect({
        animatedAttrs: {
          // height: `${this.attrs.height/2}px`,
          top: "".concat(this.attrs.height / 2, "px")
        },
      ...
      var bgPositionOut = new CSSEffect({
        animatedAttrs: {
          top: "".concat(this.attrs.height / 2, "px")
        } // initialValues: {
      ...
      var bgPositionOneOut = new CSSEffect({
        animatedAttrs: {
...
var TwoSidesReveal = /*#__PURE__*/function (_HTMLClip) {
  ...
  _createClass(TwoSidesReveal, [{
    ...
    key: "buildTree",
    value: function buildTree() {
      var bgPositionLeft = new CSSEffect({
        animatedAttrs: {
          left: "".concat(this.attrs.width / 2, "px")
        },
        initialValues: {
      ...
      var bgPositionRigth = new CSSEffect({
        animatedAttrs: {
          right: "".concat(this.attrs.width / 2, "px")
        },
        initialValues: {
...
var ColumnReveal = /*#__PURE__*/function (_HTMLClip) {
  ...
  _createClass(ColumnReveal, [{
    ...
    key: "buildTree",
    value: function buildTree() {
      var bgPositionOneIn = new CSSEffect({
        animatedAttrs: {
          top: "".concat(0, "px")
        }
      }, {
...
var ThreeSidesReveal = /*#__PURE__*/function (_HTMLClip) {
  ...
  _createClass(ThreeSidesReveal, [{
    ...
    key: "buildTree",
    value: function buildTree() {
      var bgWrapperBgColor = new CSSEffect({
        animatedAttrs: {
          opacity: 0
        },
        initialValues: {
      ...
      var bgWrapperOpacity = new CSSEffect({
        animatedAttrs: {
          opacity: 1
        },
        initialValues: {
